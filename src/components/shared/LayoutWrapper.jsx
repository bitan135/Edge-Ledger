  ...
  return (
    <div className="flex min-h-screen relative">
      ...
      <button
        ...
        className={`fixed left-6 top-6 z-50 p-3 rounded-xl bg-[var(--sidebar-bg)] border border-[var(--border)] text-[var(--accent)] shadow-md transition-all duration-500 hover:scale-110 active:scale-95 ${
