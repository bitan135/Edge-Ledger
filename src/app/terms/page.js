  ...
  return (
    <div className="min-h-screen bg-[#050505] text-[#fafafa] selection:bg-indigo-500/30">
      <nav className="p-6 md:p-10 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2 text-sm font-black text-white/40 hover:text-white transition-all">
      ...
      <main className="max-w-3xl mx-auto px-6 py-20">
        ...
        <div className="space-y-10 text-white/60 font-bold leading-relaxed">
          <section>
            <h2 className="text-xl font-black text-white mb-4 uppercase tracking-widest">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-xl font-black text-white mb-4 uppercase tracking-widest">3. User Responsibilities</h2>
          ...
          <section>
            <h2 className="text-xl font-black text-white mb-4 uppercase tracking-widest">4. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-xl font-black text-white mb-4 uppercase tracking-widest">5. Modifications</h2>
          ...
          <section className="pt-10 border-t border-white/5">
            ...
            <p className="text-sm mt-2">Questions? hello.bitanbiswas@gmail.com</p>
          </section>
        </div>
      </main>
