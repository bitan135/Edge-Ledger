...
const plans = [
  {
    ...
    features: ['Unlimited Trades', 'Core SMC Journaling', 'Setup Tagging (BOS/FVG)', 'Chart Uploads'],
    icon: Rocket,
    color: '#94A3B8',
  ...
  },
  {
    ...
    features: ['All Pro Features', 'One-time Payment', 'Priority Updates', 'Early Access'],
    icon: Crown,
    color: '#10B981',
