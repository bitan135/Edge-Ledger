...
import {
  ShieldAlert, LogOut, Users, DollarSign, MousePointer2,
  TrendingUp, Plus, Loader2, Copy, CheckCircle2, XCircle,
  ChevronDown, ChevronUp, Eye, EyeOff, AlertCircle, CreditCard
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white font-sans pb-20">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm font-bold text-white/60 leading-tight">Affiliate Control</p>
            </div>
          </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 pt-8">
        ...
        <div className="mb-8">
          ...
          >
            <Plus size={16} /> {showCreate ? 'Close' : 'Create New Partner'}
          </button>
              ...
              partners.map(p => (
                <div key={p.id} className="group">
                  ...
                  {expandedPartner === p.id && (
                    <div className="px-4 sm:px-6 pb-5 pt-1 bg-white/[0.01] border-t border-white/5">
